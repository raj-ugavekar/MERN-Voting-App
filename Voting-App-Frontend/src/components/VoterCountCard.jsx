function VoterCountCard({ voteCount }) {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-xl transition duration-300 
      ...
      <div className="text-center mt-4">
        <h2 className="text-3xl font-bold text-gray-700">VOTES: {voteCount?.count}</h2>
        <p className="text-gray-600 text-lg font-medium">{voteCount?.party}</p>
      </div>
    </div>
  );
}

export default VoterCountCard;
